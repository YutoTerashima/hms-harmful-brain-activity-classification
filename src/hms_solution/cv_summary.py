...
Purpose: Cross-validation, inference, and blending summary helpers.
...
MODULE_PURPOSE = 'Cross-validation, inference, and blending summary helpers.'
...
def cv_table(rows: Iterable[Mapping[str, Any]]) -> list[dict[str, Any]]:
...
def inference_stages(records: Iterable[Mapping[str, Any]], field: str = "failure_type") -> list[dict[str, Any]]:
